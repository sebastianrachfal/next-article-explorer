...
export default function Header() {
	return (
		<header className='z-50 fixed text-gray-700 bg-white body-font w-full'>
			<div className='flex flex-wrap p-5 mx-auto border-b justify-between flex-row'>
				...
				<nav className='inline-flex items-center justify-center text-base md:ml-auto '>
					<Link href='/'>
						<a className='mr-5 text-sm font-semibold text-gray-600 hover:text-gray-800'>.home</a>
					</Link>
					<Link href='/'>
						<a className='text-sm font-semibold text-gray-400 hover:text-gray-800'>.me</a>
					</Link>
				</nav>
